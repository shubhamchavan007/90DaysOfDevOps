...
Q1)What Defines my Learning plan is:- 
...
My 3 Clear Goals for the next 90 Days 
    1) To Remove the fact that this challenge can't be done by anyone with JOSH.
    2) To Learn About DevOps Engineering and the backend process of how it powers the upcoming Technologies.
    3) There is No Plan B.
My 3 Core DevOps Skills which i want to build is
    1) Troubleshooting & Debugging.
    2) Learn Concepts like terraform, kubernetes and much more
    3) Expressing your Work To Others (Which I Lack A Lot.)
My Weekly Time Buddget is
    1) On Weekdays i.e (Mon To Fri) will be ~3.5hrs (7 pm to 10 pm)
    2) On WeekEnds i.e (Sat To Sun) will be ~5hrs (6pm to 11 pm)
